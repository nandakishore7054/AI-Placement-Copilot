...
export default function ApplicationsError({
  ...
  useEffect(() => {
    console.error("[ApplicationsPageError]", error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center rounded-2xl border border-destructive/20 bg-destructive/5 p-8 text-center">
      ...
      <p className="text-sm text-muted-foreground max-w-sm mb-6 leading-relaxed">
        Something went wrong while retrieving your application records. Please try refreshing or return to job listings.
      </p>
